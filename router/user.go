...
func index(c *fiber.Ctx) error {
	...
	solitudes.System.DB.Where("template_id = ?", solitudes.ArticleTemplateID).Where("array_length(tags, 1) is null OR NOT tags @> ARRAY[?]::varchar[]", "Topic").Order("read_num DESC").Limit(3).Find(&mostRead)
