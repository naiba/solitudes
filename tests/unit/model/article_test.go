...
func validateToc(t *testing.T, toc []*model.ArticleTOC, now *int, expect []int) {
...
// TestSanitizedAnchorName is skipped as it tests internal function
// func TestSanitizedAnchorName(t *testing.T) {
// 	unique := make(map[string]int)
// 	// This tests internal model function - would need to be exported
// }
